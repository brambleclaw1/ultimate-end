...
public class LargeAmethystTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static LargeAmethystTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LargeAmethystTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("ultimateend:large_amethyst_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("ultimateend:large_amethyst_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public LargeAmethystTreeFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ultimateend", "large_amethyst_tree"));
		if (template == null)
			return false;
