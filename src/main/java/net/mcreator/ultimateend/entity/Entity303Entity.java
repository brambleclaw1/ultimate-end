...
public class Entity303Entity extends Monster {
	public Entity303Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(UltimateendModEntities.ENTITY_303.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(UltimateendModBlocks.HEART_OF_ENDER.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(UltimateendModEntities.ENTITY_303.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
